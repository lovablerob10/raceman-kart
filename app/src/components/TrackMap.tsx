...
const TRACK_LAYOUTS: Record<string, string> = {
    ...
    'KNO_A': `
      ...
      Z
    `,
    // KNO Layout B - Etapa 2 Março (Traçado real com 20 curvas - mapeado da foto aérea)
    'KNO_B': `
      M 230,430
      L 170,430
      C 145,430 120,425 105,415
      L 85,400
      C 65,385 55,365 55,345
      L 55,310
      C 55,290 65,275 80,268
      L 120,250
      C 140,242 155,228 160,210
      C 165,192 155,178 140,172
      L 120,165
      C 100,158 95,142 105,128
      L 120,110
      C 130,95 148,82 170,78
      L 210,68
      C 230,64 242,55 248,42
      L 255,28
      C 262,15 278,8 295,12
      L 330,22
      C 348,28 355,42 350,58
      C 345,75 332,85 318,88
      L 295,95
      C 278,100 272,112 280,128
      L 298,155
      C 310,172 328,178 345,170
      L 365,158
      C 380,150 395,138 412,130
      L 440,118
      C 462,110 480,95 492,75
      L 505,52
      C 515,35 532,28 548,38
      C 565,48 568,68 558,85
      L 542,112
      C 532,130 528,148 535,165
      C 542,182 555,188 565,180
      L 575,168
      C 585,158 592,168 588,182
      L 578,210
      C 572,228 568,248 572,265
      L 578,290
      C 582,308 575,325 562,338
      L 545,358
      C 530,370 512,378 492,375
      L 468,368
      C 448,362 432,368 425,382
      L 415,400
      C 408,415 392,420 378,412
      L 348,392
      C 335,385 320,388 315,400
      L 308,418
      C 300,432 285,435 272,428
      L 252,415
      C 242,408 235,415 235,428
      Z
    `,
